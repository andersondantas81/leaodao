...
const App = () => {
  ...
  const editionDrop = useEditionDrop(
    "0xa48eE679Ea2F8d0E42aEa0547BB291A1275E9838"
  );
  console.log(editionDrop);
  const token = useToken("0x2FF4C211f8Fb5Ed3c94e588c447aaFf252ff1b28");

  const vote = useVote("0x415C6ca3a062c9F65E25261B33517aeFbA7867CB");
  ...
  return (
    <div className="mint-nft">
      <h1>Cunhe gratuitamente seu NFT de membro 🦁 da LEAODAO</h1>
