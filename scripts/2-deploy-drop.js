...
(async () => {
  ...
  try {
    ...
    const editionDropAddress = await sdk.deployer.deployEditionDrop({
      ...
      name: "Membro da LEAODAO",

      // Uma descrição para a coleção.
      description: "LEAODAO - A DAO do maior clube de futebol do Nordeste - Fortaleza Esporte Clube",

      // Uma imagem para a coleção que vai aparecer no OpenSea.
      image: readFileSync("scripts/assets/fec.png"),
